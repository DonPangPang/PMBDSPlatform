...
namespace PMBDS.JT808.Gateway.PipelineFilters
{
    public class JT808PipelineFilter: BeginEndMarkPipelineFilter<byte[]>
    {
        ...
        protected override byte[] DecodePackage(ref ReadOnlySequence<byte> buffer)
        {
            ...
            //var jT808Package = Jt808Serializer.HeaderDeserialize(buff);
            return data;
        }
    }
}